...
#endif
            VL_FATAL_MT("generated-src/ALU.v", 1, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void VALU___024root___eval_stl(VALU___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
        vlSelfRef.io_aluResult = ((0U == (IData)(vlSelfRef.io_operation))
                                   ? (vlSelfRef.io_operandA 
                                      + vlSelfRef.io_operandB)
                                   : ((1U == (IData)(vlSelfRef.io_operation))
                                       ? (vlSelfRef.io_operandA 
                                          - vlSelfRef.io_operandB)
                                       : ((2U == (IData)(vlSelfRef.io_operation))
                                           ? (vlSelfRef.io_operandA 
                                              & vlSelfRef.io_operandB)
                                           : ((3U == (IData)(vlSelfRef.io_operation))
                                               ? (vlSelfRef.io_operandA 
                                                  | vlSelfRef.io_operandB)
                                               : ((4U 
...
VL_ATTR_COLD void VALU___024root___ctor_var_reset(VALU___024root* vlSelf) {
    ...
    vlSelf->io_operandA = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6853317200138628819ull);
    vlSelf->io_operandB = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6544225924211882034ull);
    vlSelf->io_operation = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 16538612106276718118ull);
    vlSelf->io_aluResult = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1038922602714931839ull);
