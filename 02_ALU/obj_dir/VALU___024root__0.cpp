                               ...
                               : ((1U == (IData)(vlSelfRef.io_operation))
                                   ...
                                   : ((2U == (IData)(vlSelfRef.io_operation))
                                       ...
                                       : ((3U == (IData)(vlSelfRef.io_operation))
                                           ? (vlSelfRef.io_operandA 
                                              | vlSelfRef.io_operandB)
                                           : ((4U == (IData)(vlSelfRef.io_operation))
                                               ? (vlSelfRef.io_operandA 
                                                  ^ vlSelfRef.io_operandB)
                                               : ((5U 
...
void VALU___024root___eval(VALU___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            VALU___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("generated-src/ALU.v", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
